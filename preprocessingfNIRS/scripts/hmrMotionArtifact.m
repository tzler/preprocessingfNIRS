...
function data = hmrMotionArtifact(data)
...
v2struct(data.cfg.motionArt)
d = data.d; info.d = d; 
fs = 1/(data.t(2)-data.t(1)); info.fs = fs;  
SD = data.SD; info.SD = SD; 
