...
function [data] = auto_hmrBlockAvg(data)
...
s = data.s; info.s = s; 
t = data.t;  info.t = t; 
trange = data.cfg.blockavg.trange; info.trange = trange; 
%% 
...
data.procResult.dcAvg = yavg; 
data.procResult.dcAvgStd = ystd; 
data.procResult.dcSum2 = ysum2; 
data.procResult.tHRF = tHRF; 
data.procResult.nTrials = nTrials; 
results = yavg; % kind of a whatever choice 
